...
<div class="d-flex flex-column flex-root">
    <div class="error error-6 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url({{url('admin/assets/media/errors/bg6.jpg')}});">
        <div class="d-flex flex-column flex-row-fluid text-center">
            <h3 class="error-title font-weight-boldest text-white mb-12" style="margin-top: 12rem; font-size: 5rem !important;">404</h3>
            <p class="display-4 font-weight-bold text-white">{{ __('lang.error_404_m1') }}</p>
