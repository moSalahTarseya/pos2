                                            ...
                                            <div class="show active" id="content-1" role="tabpanel" aria-labelledby="content-1-tab">
                                                <div class="">
                                                    <div class="flex items-center">
                                                        <img class="w3-round" src="{{ $user->image? asset($user->image) : url('images/user.png') }}" style="width: 50px;" alt="">
                                                        <h3>{{ $user->name }}</h3>
                                                    </div>
                                                    ...
                                                    <div class="text_view">
                                                        <p><strong> {{ __('dashboard.phone') }} : </strong> {{ $user->phone }}</p>
                                                    </div>
                                                    <div class="text_view">
                                                        <p><strong> {{ __('dashboard.status') }} : </strong> {{ __('lang.'. $user->status) }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
