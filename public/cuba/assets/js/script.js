(function($) {
    ...
    $(".mode").on("click", function() {
        ...
        $('table tbody tr').toggleClass("mode-dark-style");
        $('table tbody tr td').toggleClass("mode-dark-style");
        $('table thead tr').toggleClass("mode-dark-style");
        $('table thead tr th').toggleClass("mode-dark-style");
        var color = $(this).attr("data-attr");
        localStorage.setItem('body', 'dark-only');
    });

    var darkSession = $('body').data('session');
    // console.log(darkSession);
    if(darkSession == 'dark-only'){
        $('.mode i').addClass("fa-lightbulb-o").removeClass("fa-moon-o");

        $('table').removeClass("table-striped");
        $('table tbody tr').addClass("mode-dark-style");
        $('table tbody tr td').addClass("mode-dark-style");
        $('table thead tr').addClass("mode-dark-style");
        $('table thead tr th').addClass("mode-dark-style");
    }else{
        $('.mode i').addClass("fa-moon-o").removeClass("fa-lightbulb-o");

        $('table').addClass("table-striped");
        $('table tbody tr').removeClass("mode-dark-style");
        $('table tbody tr td').removeClass("mode-dark-style");
        $('table thead tr').removeClass("mode-dark-style");
        $('table thead tr th').removeClass("mode-dark-style");
    }
